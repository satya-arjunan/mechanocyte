...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
      subroutine modriver(icyc,epsl,idebug)
!
...
!
      implicit none
!
      integer icyc!number of iterations
      real(8) epsl!tolerance for pdel (p change during iteration)
      integer idebug!debugging flag
!
